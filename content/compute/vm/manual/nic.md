...
![](/compute/vm/manual/_images/nic_1.png)

3. 点击右键，选择 **加入VPC网络**，如下图所示。

![](/compute/vm/manual/_images/nic_2.png)
...
![](/compute/vm/manual/_images/nic_3.png)

3. 在 **计算** > **网卡** 页面中，点击 **申请**，创建网卡。

![](/compute/vm/manual/_images/nic_4.png)

4. 点击**选择私有网络**，将新申请的网卡加入到刚刚建立的私有网络中，如下图所示。

![](/compute/vm/manual/_images/nic_5.png)

5. 点击提交，然后返回到网卡申请对话框，此时需要为其分配一个IP地址：

![](/compute/vm/manual/_images/nic_6.png)
...
![](/compute/vm/manual/_images/nic_7.png)
...
6. 添加网卡成功，如果有更多添加网卡的需求，请按照上面步骤配置即可。
